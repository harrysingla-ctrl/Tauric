...
We built TradingAgents with LangGraph to ensure flexibility and modularity. The framework supports multiple LLM providers: OpenAI, Google, Anthropic, xAI, DeepSeek, Qwen (Alibaba DashScope), GLM (Zhipu), NVIDIA (NIM), OpenRouter, Ollama for local models, and Azure OpenAI for enterprise.
...
config["llm_provider"] = "openai"        # openai, google, anthropic, xai, deepseek, qwen, glm, nvidia, openrouter, ollama, azure
